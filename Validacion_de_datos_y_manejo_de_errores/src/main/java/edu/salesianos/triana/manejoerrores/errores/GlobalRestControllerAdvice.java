package edu.salesianos.triana.manejoerrores.errores;

import edu.salesianos.triana.manejoerrores.errores.excepciones.EntityNotFoundException;
import edu.salesianos.triana.manejoerrores.errores.model.ApiError;
import edu.salesianos.triana.manejoerrores.errores.model.ApiSubError;
import edu.salesianos.triana.manejoerrores.errores.model.ApiValidationSubError;
...
public class GlobalRestControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        return buildApiError("Errores varios en la validación", request, ex.getFieldErrors()
                .stream().map(error -> ApiValidationSubError.builder().objeto(error.getObjectName())
                        .campo(error.getField())
                        .valorRechazado(error.getRejectedValue()).mensaje(error.getDefaultMessage())
